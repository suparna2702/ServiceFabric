...
/**
 * Utility class for creating instances of {@link ActivityType}.
...
public class TypeFactory {
	 ...
	 *  
	 * @param clazz ActivityType class of the type to create
	 * @param arguments ActivityType arguments for the variables of <tt>clazz</tt>, or null if these are not known.
	 ...
	 * (or {@link #parameterizedClass(Class, ActivityType...)} or {@link #innerClass(ActivityType, Class)} could be used).
