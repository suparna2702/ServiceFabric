...
public class ContentWorkspaceDocumentUploadedWallEntryDto extends
    ContentWorkspaceDocumentWallEntryDto {

  protected ContentWorkspaceDocumentUploadedWallEntryDto() {

  }

  public ContentWorkspaceDocumentUploadedWallEntryDto(DocumentDto document,
  ...
  public WallEntryType getType() {
    return WallEntryType.CONTENT_WORKSPACE_DOCUMENT_UPLOADED;
  }
