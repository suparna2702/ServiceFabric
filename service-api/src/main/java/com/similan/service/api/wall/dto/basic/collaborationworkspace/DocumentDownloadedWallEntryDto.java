...
public class DocumentDownloadedWallEntryDto extends
    CollaborationWorkspaceDocumentWallEntryDto {

  protected DocumentDownloadedWallEntryDto() {
  }

  public DocumentDownloadedWallEntryDto(SharedDocumentDto sharedDocument,
  ...
  public WallEntryType getType() {
    return WallEntryType.COLLABORATION_WORKSPACE_DOCUMENT_DOWNLOADED;
  }
