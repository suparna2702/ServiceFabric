...
public class ContentWorkspaceDocumentViewedWallEntryDto extends
    ContentWorkspaceDocumentWallEntryDto {

  public ContentWorkspaceDocumentViewedWallEntryDto(DocumentDto document,
  ...
  public WallEntryType getType() {
    return WallEntryType.CONTENT_WORKSPACE_DOCUMENT_VIEWED;
  }
