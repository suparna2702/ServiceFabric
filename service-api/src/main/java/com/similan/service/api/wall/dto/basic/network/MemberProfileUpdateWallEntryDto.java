...
@ToString
public class MemberProfileUpdateWallEntryDto extends
    SocialActorProfileWallEntryDto {

  public MemberProfileUpdateWallEntryDto(ActorDto profileOwnerActor,
  ...
  public WallEntryType getType() {
    return WallEntryType.MEMBER_PROFILE_UPDATED;
  }
