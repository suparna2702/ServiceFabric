...
public class ContentWorkspaceDocumentCheckOutWallEntryDto extends
    ContentWorkspaceDocumentWallEntryDto {

  public ContentWorkspaceDocumentCheckOutWallEntryDto(DocumentDto document,
  ...
  public WallEntryType getType() {
    return WallEntryType.CONTENT_WORKSPACE_DOCUMENT_CHECKOUT;
  }
