...
import com.similan.service.api.wall.dto.basic.contentspace.ContentWorkspaceDocumentCheckInWallEntryDto;
...
@Component
public class ContentWorkspaceDocumentCheckInWallEntryMarshaller
    extends
    WallEntryMarshaller<ContentWorkspaceDocumentCheckInWallEntry, ManagementWorkspaceKey> {
  @Autowired
  ...
  public WallEntryDto<ManagementWorkspaceKey> marshall(
      ...
      ContentWorkspaceDocumentCheckInWallEntry entry) {
    ...
    ContentWorkspaceDocumentCheckInWallEntryDto entryDto = new ContentWorkspaceDocumentCheckInWallEntryDto(
