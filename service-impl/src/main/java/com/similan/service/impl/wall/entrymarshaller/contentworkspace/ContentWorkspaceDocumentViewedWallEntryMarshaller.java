...
import com.similan.service.api.wall.dto.basic.contentspace.ContentWorkspaceDocumentViewedWallEntryDto;
...
@Component
public class ContentWorkspaceDocumentViewedWallEntryMarshaller
    extends
    WallEntryMarshaller<ContentWorkspaceDocumentViewedWallEntry, ManagementWorkspaceKey> {
  ...
  public WallEntryDto<ManagementWorkspaceKey> marshall(
      ...
      ContentWorkspaceDocumentViewedWallEntry entry) {
    ...
    ContentWorkspaceDocumentViewedWallEntryDto entryDto = new ContentWorkspaceDocumentViewedWallEntryDto(
