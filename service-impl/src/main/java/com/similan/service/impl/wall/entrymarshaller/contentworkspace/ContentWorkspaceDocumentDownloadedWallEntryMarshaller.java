...
import com.similan.service.api.wall.dto.basic.contentspace.ContentWorkspaceDocumentDownloadedWallEntryDto;
...
@Component
public class ContentWorkspaceDocumentDownloadedWallEntryMarshaller
    extends
    WallEntryMarshaller<ContentWorkspaceDocumentDownloadedWallEntry, ManagementWorkspaceKey> {
  @Autowired
  ...
  public WallEntryDto<ManagementWorkspaceKey> marshall(
      ...
      ContentWorkspaceDocumentDownloadedWallEntry entry) {
    ...
    ContentWorkspaceDocumentDownloadedWallEntryDto entryDto = new ContentWorkspaceDocumentDownloadedWallEntryDto(
