...
import com.similan.service.api.wall.dto.basic.collaborationworkspace.DocumentDownloadedWallEntryDto;
...
@Component
public class DocumentDownloadedWallEntryMarshaller extends
    WallEntryMarshaller<DocumentDownloadedWallEntry, CollaborationWorkspaceKey> {
  @Autowired
  ...
  public WallEntryDto<CollaborationWorkspaceKey> marshall(
      ...
      DocumentDownloadedWallEntry entry) {
    ...
    DocumentDownloadedWallEntryDto entryDto = new DocumentDownloadedWallEntryDto(
