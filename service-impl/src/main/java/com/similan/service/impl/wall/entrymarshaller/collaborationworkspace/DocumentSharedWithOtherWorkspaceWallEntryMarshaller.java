...
import com.similan.service.api.wall.dto.basic.collaborationworkspace.DocumentSharedWithOtherWorkspaceWallEntryDto;
...
@Component
public class DocumentSharedWithOtherWorkspaceWallEntryMarshaller extends
                 WallEntryMarshaller<DocumentSharedWithOtherWorkspaceWallEntry, CollaborationWorkspaceKey>{
  @Autowired
  ...
  private CollaborationWorkspaceMarshaller collaborationWorkspaceMarshaller;
	...
	public WallEntryDto<CollaborationWorkspaceKey> marshall(
			...
			DocumentSharedWithOtherWorkspaceWallEntry entry) {
		...
		CollaborationWorkspace sharedFromWorkspace = entry.getSharedFromSpace();
		CollaborationWorkspaceKey sharedFromSpaceKey = collaborationWorkspaceMarshaller.marshallWorkspaceKey(sharedFromWorkspace);
		
		DocumentSharedWithOtherWorkspaceWallEntryDto wallEntryDto = 
				new DocumentSharedWithOtherWorkspaceWallEntryDto(sharedDocumentDto,
						initiatorDto, sharedFromSpaceKey, entryKey, date, 
