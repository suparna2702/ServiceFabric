...
import com.similan.service.api.wall.dto.basic.contentspace.ContentWorkspaceDocumentUpdateWallEntryDto;
...
@Component
public class ContentWorkspaceDocumentUpdateWallEntryMarshaller
    extends
    WallEntryMarshaller<ContentWorkspaceDocumentUpdateWallEntry, ManagementWorkspaceKey> {
  @Autowired
  ...
  public WallEntryDto<ManagementWorkspaceKey> marshall(
      WallEntryKey<ManagementWorkspaceKey> entryKey, ActorDto initiatorDto,
      Date date, ContentWorkspaceDocumentUpdateWallEntry entry) {
    ...
    ContentWorkspaceDocumentUpdateWallEntryDto entryDto = new ContentWorkspaceDocumentUpdateWallEntryDto(
