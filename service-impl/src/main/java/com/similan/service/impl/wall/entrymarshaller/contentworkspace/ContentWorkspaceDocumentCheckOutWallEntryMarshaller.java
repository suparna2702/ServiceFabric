...
import com.similan.service.api.wall.dto.basic.contentspace.ContentWorkspaceDocumentCheckOutWallEntryDto;
...
@Component
public class ContentWorkspaceDocumentCheckOutWallEntryMarshaller
    extends
    WallEntryMarshaller<ContentWorkspaceDocumentCheckOutWallEntry, ManagementWorkspaceKey> {
  @Autowired
  ...
  public WallEntryDto<ManagementWorkspaceKey> marshall(
      ...
      ContentWorkspaceDocumentCheckOutWallEntry entry) {
    ...
    ContentWorkspaceDocumentCheckOutWallEntryDto entryDto = new ContentWorkspaceDocumentCheckOutWallEntryDto(
